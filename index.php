...
<body data-spy="scroll" data-target=".navbar" data-offset="60">
      ...
      <div class="container col-md-12">
        <div class="row">
          ...
          <div class="col-md-12 d-flex justify-content-center">
            ...
            <div class="index mt-4 span3 wow flip" data-wow-iteration="5" data-wow-duration="0.15s" style="visibility: visible; animation-duration: 0.15s; animation-iteration-count: 5;">
    ...
    <section id="projets">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="hovereffect">
              <img class="img-thumbnail" id="image" src="images/jeuDeTir.PNG" alt="projet-inauguration" />
              <div class="overlay">
                <h2>Jeu de tir</h2>
                <a href="http://joansor.fr/jeuDeTir/" class="info" target="_blank">J'ai réalisé en JavaScript</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="hovereffect">
              <img class="img-thumbnail" id="image" src="images/escapeGame.PNG" alt="projet-escapeGame" />
              <div class="overlay">
                <h2>Intégration depuis une maquette</h2>
                <a href="http://joansor.fr/escapeGame" class="info" target="_blank">Réalisation en
                  HTML/CSS/Bootstrap<br>Gimp & Inkscape</a>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
            <div class="hovereffect">
              <img class="img-thumbnail" id="image" src="images/cpk.png" alt="cpk" />
              <div class="overlay">
                <h2>CPK Kingersheim</h2>
                <a href="http://joansor.fr/CPK" class="info" target="_blank">Site club de pingpong
                  réalisé en PHP</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="hovereffect">
              ...
              <div class="overlay">
                ...
                <a href="http://joansor.fr/inaugurationACS/" class="info" target="_blank">Projet préparé pour une journée
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="hovereffect">
              <img class="img-thumbnail" id="image" src="images/PanierJS.PNG" alt="projet-inauguration" />
              <div class="overlay">
                <h2>Panier d'achat</h2>
                <a href="http://joansor.fr/panierJS/" class="info" target="_blank">J'ai réalisé en JavaScript</a>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="hovereffect">
              <img class="img-thumbnail" id="image" src="images/plateauExpress.png" alt="projet-inauguration" />
              <div class="overlay">
                <h2>Liste produits chaud/froid</h2>
                <a href="http://joansor.fr/ArtPlateauExpress" class="info" target="_blank">J'ai réalisé en PHP, Jquery, JavaScript</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 mt-2">
          <div class="education-block">
            ...
            <h4>SERFA &middot; Université de Haute-Alsace<h5>(Mulhouse)</h5>
            </h4>
            <div class="divider"></div>
        ...
        <div class="col-md-4 mt-2">
          <div class="education-block">
            <h5>2021</h5>
            <span class="fas fa-graduation-cap"></span>
            <h3>Formation certifiante <h5>(bac+3)</h5>
            </h3>
            <h4>SERFA &middot; Université de Haute-Alsace<h5>(Mulhouse)</h5>
            </h4>
            <div class="divider"></div>
    ...
    <div class="container">
      ...
      <form action="" method="post" autocomplete="off">
        ...
        <div style="margin-top: 20px">
          <input type="checkbox" name="consent" value="consent" id="consent" label="" required>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="line-height: 1.75em; color: #faf0dc;">J’ai lu et accepte <a href="politique-de-confidentialitée.html" style="color: #faf0dc;" target="_blank">la
  ...
  <footer class="text-center">
    ...
    <a class="icons" href="www.linkedin.com/in/joan-sor" target="_blank"><img class="icon-img shake-horizontal" src="images/in.png" /></a>
  </footer>
  </div>
